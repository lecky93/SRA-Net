...
class WeaklyNet5(BaseModel):
    ...
    def loss(self, feats_cat, feats_residual, decoded_mask, pam_mask, cam_mask, datasample):
        labels = []
        cls_labels = []
