...
class AdaptiveCELoss(nn.Module):
    ...
    def forward(self,
        ...
        for class_id in range(num_class):
            ...
            custem_label[custem_label == class_id] = 1
            custem_label[custem_label == -1] = 0
            class_num_pixels = custem_label.sum()
            if class_num_pixels == 0:
                class_weight[class_id] = 0
            else:
                class_weight[class_id] = ((batch_size * H * W) - class_num_pixels) / (batch_size * H * W)
